...
const searchStatistical = async () => {
  ...
  condition += defaultGame.value.gameType
...
<template>
  <div class="search-user">
    ...
    <v-btn class="icon" append-icon="mdi-magnify" @click="searchStatistical()">
      Tìm Kiếm
    </v-btn>
  </div>
  <div class="container-search">
    <table class="table">
      ...
      <tbody class="body">
        ...
        <tr v-for="item in statistical" :key="item.time" class="row">
