...
const getThumnail = (blog: any) => {
  return blog._embedded['wp:featuredmedia']
    ? blog._embedded['wp:featuredmedia'][0]?.source_url
    : 'https://about.me/cdn-cgi/image/q=80,dpr=1,f=auto,fit=cover,w=1200,h=630,gravity=auto/https://assets.about.me/background/users/c/h/a/chanlebankpage_1711221274_592.jpg'
}
</script>
