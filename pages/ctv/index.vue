...
onMounted(async () => {
	...
	urlIntroduce.value = `https://chanlebank.page/?u=${userName.value}`

	const auth = getAuthUser()

	totalIntro.value = auth?.countIntro
})
	...
	<div class="container">
		...
		<div class="body">
			...
			<div class="link">
				...
				<v-icon class="copy" icon="mdi-content-copy" @click="copyUrlIntroduce" v-if="!isCopyUrlIntro"></v-icon>
				<v-icon class="copy" icon="mdi-check" v-if="isCopyUrlIntro"></v-icon>
			</div>
		...
		<div class="content-note">
			...
			<ul class="text">
				...
				<li>+ A sẽ dc hưởng 1% tổng tiền thắng trong 1 tháng của B và 5% tổng tiền thua trong 1 tháng của B</li>
			</ul>

			<h3 class="note  marked">Lưu ý: </h3>
			<ul class="text">
				<li>+ TÀI KHOẢN BANK CỦA BẠN TỰ ĐỘNG Ở CHẾ ĐỘ BẢO VỆ SAU LẦN TRẢ THƯỞNG THÀNH CÔNG ĐẦU TIÊN.</li>
			</ul>
		</div>
	</div>
</template>
